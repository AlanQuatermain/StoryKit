...
=== node: ritual_candle_lit ===
When the Black Candle takes fire, the flame does not illuminate so much as claim. Shadows withdraw into taller versions of themselves and the temperature drops by a degree the body considers personal. The candle's light finds the walls and makes them confess their dampness. A draft enters from somewhere that should not have passages, carrying the smell of earth that has never known rain.

=== node: ritual_tome_read ===
When you open the Tome, the pages hesitate—as if you had asked a favor of a clerk who despises you—and then offer lines that seem to read you back. You speak the words because there is no world in which silence would save you now. The symbols on the page seem to shift in your peripheral vision, rearranging themselves into patterns that make your teeth ache. When you close the book, the echoes of the words continue moving through the chamber like water finding its level.

=== node: ritual_sacrifice_complete ===
The Dagger raises silver that is heavier than its length predicts. When the blade meets the heart in the basin, sound shatters like glass dropped into snow. The beat doubles, stutters, falters. The room leans hard to one side, as if the house tried to rise and tripped on a memory. Your shoulder meets stone; your palm finds the floor; your mouth tastes iron only because your teeth have struck each other.
What leaves the chamber when the beat ceases is not smoke, not wind, not light, and yet the absence it creates rings like a bell. You are alone with your breath and the knowledge that something which prefers to remain unnamed just learned yours and decided not to keep it. The tunnel beyond is the size of a future and the house above waits to learn which one you choose.

=== node: pantry_locked ===
The pantry door wears its lock like jewelry from a more careful age. Iron has taught the wood patience; the wood has taught the iron to endure. A keyhole watches with the steady attention of an eye that has seen many hands try to coax it into friendship. The door frame shows the faint marks of fingernails that once argued for entry. Behind the door, you hear the quiet breathing of shelves that hold their contents like secrets.

=== node: library_case_locked ===
The glass case holds its treasures behind crystal that has learned to bend light into warnings. A brass lock guards the door with the dignity of a banker from an era when banks were cathedrals. Through the glass you see volumes that seem to shift when you are not looking directly at them, their spines rearranging themselves like schoolchildren who know they are being watched. The case hums quietly, a sound that might be the books talking among themselves or the brass remembering when it sang in an orchestra.

=== node: library_case_unlocked ===
The brass key turns with a sigh, as if the lock had been holding its breath for decades. The glass door opens without protest, releasing the scent of paper that has absorbed centuries of candlelight. Inside, the volumes lean toward you with the eagerness of stories that have waited too long to be told. Among them, a black candle sits like a punctuation mark between chapters, its wick unburned but somehow wise.
